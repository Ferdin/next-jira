...
export default function CommandPanel() {
  ...
  return (
    <div className="bg-white rounded-md flex flex-row h-20  w-full font-sans">
      ...
      <div className="mt-auto mb-auto pr-2">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
      ...
      <div className="mt-auto mb-auto p-4">
        <NJButton onPress={onOpen} label="ticket" />
        <TicketModal isOpen={isOpen} onOpenChange={onOpenChange} />
      </div>
    </div>
  );
}
